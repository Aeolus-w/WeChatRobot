...
from routes import completion, config, state_cache, midi, misc, file_process, upload
import global_var
...
# /root/autodl-tmp/RWKV/RWKV-x060-World-7B-v2.1-20240507-ctx4096.pth
# /root/autodl-tmp/RWKV/state_tuning/self_rwkv.pth
# /root/autodl-tmp/RWKV/lora/self_rwkv_lora.pth
# /root/autodl-tmp/RWKV/lora/self_child_lora.pth
# /root/autodl-tmp/RWKV/lora/self_network.pth
# /root/autodl-tmp/RWKV/lora/self_network_all_40.pth
